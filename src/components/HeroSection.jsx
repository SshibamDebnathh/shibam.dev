  ...
  return (
    <div id="home" className="flex flex-wrap lg:justify-between w-full gap-10 mt-12 min-h-screen justify-center items-center lg:px-16">
      ...
      <div className="flex items-center animate-bounce lg:mr-10 px-20 justify-center">
        <div className="absolute border-4 border-purple-300 z-0 skew-x-12 skew-y-12 shadow-purple-300 shadow-2xl lg:w-52 lg:h-60 w-32 h-40 md:w-40 md:h-48 min-w-32" ></div>
        <img src={shibam} alt="shibam" className="relative rounded-full shadow-purple-400 shadow-2xl border-4 p-2 border-purple-300 z-20 lg:w-52 lg:h-52 w-32 h-32 md:w-40 md:h-40 min-w-32" />
        <div className=" absolute border-4 border-purple-300 z-10 -skew-x-12 -skew-y-12 shadow-purple-300 shadow-2xl lg:w-52 lg:h-60 w-32 h-40 md:w-40 md:h-48"></div>
      </div>
    </div>
