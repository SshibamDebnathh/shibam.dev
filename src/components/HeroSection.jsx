...
export default function HeroSection() {
  ...
  return (
    <div id="home" className="flex flex-wrap lg:justify-between w-full lg:gap-10 gap-10 md:gap-16 mt-12 min-h-screen p-16 justify-center items-center">

      <motion.div
        initial={{ opacity: 0, y: -30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="flex flex-col text-center bg-gray-500 lg:h-80 rounded-lg lg:px-10 px-3 justify-center items-center lg:gap-5 border-2 border-purple-300 shadow-purple-400 shadow-xl lg:mx-14 h-56 text-purple-200"
      >
